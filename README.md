...
[![Build Status](https://drone.io/github.com/ClearGrass/bee/status.png)](https://drone.io/github.com/ClearGrass/bee/latest)
...
```bash
go get github.com/ClearGrass/bee
```
...
```bash
go get -u github.com/ClearGrass/bee
```
